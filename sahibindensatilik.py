...
for sayfaNo in range(1,10):
    url = "https://www.hurriyetemlak.com/cankaya-satilik-sahibinden?p56=54325-14922-988-14924-54330-657-54327-54329-54331&page="+str(sayfaNo)
    r= requests.get(url)
...
print(dt)
wb.save('hurriyetsahibindenbolge'+dt+'.xls')