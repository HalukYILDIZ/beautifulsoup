...
style3=easyxf('pattern: pattern solid, fore_colour light_yellow;'
                              'font: colour black, bold True;')
style4=easyxf('pattern: pattern solid, fore_colour light_orange;'
                              'font: colour black, bold True;')
style5=easyxf('pattern: pattern solid, fore_colour light_blue;'
                              'font: colour black, bold True;')
for i in range(1,31):
...
for sayfaNo in range(1,10):
    url = "https://www.hurriyetemlak.com/cankaya-kiralik-sahibinden?p56=54325-16837-14922-988-14924-54326-54330-599-657-54327-54329-54331&page="+str(sayfaNo)
    r= requests.get(url)
...
print(dt)
wb.save('hurriyetsahibindenbolgekiralik'+dt+'.xls')